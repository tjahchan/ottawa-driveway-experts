  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gradient-gold text-accent-foreground font-semibold shadow-gold hover:shadow-[0_16px_50px_-10px_hsl(36_78%_52%/0.6)] hover:-translate-y-0.5",
        "outline-light": "border border-white/30 bg-white/5 text-white backdrop-blur-md hover:bg-white/15 hover:border-white/50",
        dark: "bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 shadow-card",
      },
      size: {
